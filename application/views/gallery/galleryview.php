  ...
  <style type="text/css">
            ...
            #container_page .pagination ul li.inactive,
            #container_page .pagination ul li.inactive:hover{
            ...
            #container_page .pagination{
                width: 800px;
                height: 25px;
                float:left;
            }
            #container_page .pagination ul li{
                list-style: none;
                float: left;
            ...
            #container_page .pagination ul li:hover{
                color: #fff;
                background-color: #CA0054;
                cursor: pointer;
            }
 ...
 <div class="container">
     ...
     <center> <div id="loading" class="loading"></div></center>
